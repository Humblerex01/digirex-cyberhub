    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 text-white">
        ...
        <section className="py-20 max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-12 text-[#09F289]">
            Our Services
          </h2>
          <div className="grid md:grid-cols-3 gap-10">
            <div className="p-6 bg-[#090055]/40 backdrop-blur-md rounded-2xl shadow-lg border border-[#08CF75]">
              <h3 className="text-2xl font-semibold mb-3 text-[#09F289]">
                Web Development
              </h3>
            ...
            <div className="p-6 bg-[#090055]/40 backdrop-blur-md rounded-2xl shadow-lg border border-[#08CF75]">
              ...
              <p>
                Engaging graphics, videos, and digital content to grow your brand.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 text-center">
          <h2 className="text-4xl font-bold mb-6 text-[#09F289]">
            Ready to Go Digital?
          </h2>
        ...
        {/* Footer */}
        <footer className="backdrop-blur-md text-white py-10 border-t border-white/10">
          <div className="max-w-6xl mx-auto px-6 space-y-10 md:space-y-0">
            {/* About / Brand */}
            <div className="text-left mb-8 md:mb-0">
              <h3 className="text-2xl font-bold text-[#09F289]">
                DigiRex Cyber Hub
              </h3>
              <p className="mt-3 text-sm opacity-80">
                Empowering individuals and businesses with cutting-edge technology
                solutions, robust cybersecurity strategies, innovative web
                development, creative digital content, and forward-looking crypto
                innovations that drive growth, security, and digital
                transformation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-8">
              ...
              <div className="text-left">
                <h4 className="text-lg font-semibold mb-3 text-[#09F289]">
                  Quick Links
                </h4>
                <ul className="space-y-2 text-sm opacity-90">
                  <li>
                    <Link
                      href="/"
                      className="hover:text-[#09F289] hover:underline"
                    >
                      Home
                    </Link>
                  </li>
              ...
              <div className="col-span-2 md:col-span-1 text-left mt-8 md:mt-0">
                ...
                <div className="flex items-center gap-2 text-sm opacity-90 mb-2">
                  ...
                  <Link
                    href="mailto:digirexcyberhub@gmail.com"
                    className="text-white hover:underline hover:text-[#09F289]"
                  >
